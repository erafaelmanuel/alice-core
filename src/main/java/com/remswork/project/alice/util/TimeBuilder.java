package com.remswork.project.alice.util;
...
public class TimeBuilder {
    ...
    public TimeBuilder addHour(int hour) {
        time.setHour((time.getHour() + hour) % 24);
        return this;
    }

    public TimeBuilder addMinute(int minute) {
    ...
    public TimeBuilder addSecond(int second) {
    ...
    public TimeBuilder convert(String stringDate) {
        try {
            String pattern[] = {
                    "((0?[1-9])|(1[0-9])|(2[0-4])):((0?[0-9])|(1[0-9])|(2[0-9])|" +
                    "(3[0-9])|(4[0-9])|(5[0-9])):((0?[0-9])|(1[0-9])|(2[0-9])|(3[0-9])|(4[0-9])|(5[0-9]))",
                    "((0?[1-9])|(1[0-9])|(2[0-4])) hrs ((0?[0-9])|(1[0-9])|(2[0-9])|(3[0-9])|(4[0-9])|(5[0-9])) mins",
                    "((0?[1-9])|(1[012])):((0?[0-9])|(1[0-9])|(2[0-9])|(3[0-9])|(4[0-9])|(5[0-9])) [AP]M"};
            if (stringDate.matches(pattern[0])) {
                ...
                time.setHour((m.equals("PM") ? (hour == 12 ? 12 : hour + 12) : (hour == 12 ? hour + 12 : hour)));
                time.setMinute(minute);
                time.setSecond(second);
                return this;
            } else
